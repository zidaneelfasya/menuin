...
export async function updateCatalogOrdering(formData: FormData) {
  ...
  const dineInEnabled = formData.get("dineInEnabled") === "true" || formData.get("dineInEnabled") === "on";
  const takeAwayEnabled = formData.get("takeAwayEnabled") === "true" || formData.get("takeAwayEnabled") === "on";
  const deliveryEnabled = formData.get("deliveryEnabled") === "true" || formData.get("deliveryEnabled") === "on";
  const customerNameRequired = formData.get("customerNameRequired") === "true" || formData.get("customerNameRequired") === "on";
  const customerPhoneRequired = formData.get("customerPhoneRequired") === "true" || formData.get("customerPhoneRequired") === "on";
  const tableNumberRequired = formData.get("tableNumberRequired") === "true" || formData.get("tableNumberRequired") === "on";
