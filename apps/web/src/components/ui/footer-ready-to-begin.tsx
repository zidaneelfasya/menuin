...
export default function FooterReadyToBegin({
  title = "Jam sibuk berikutnya, biar Menuin yang atur.",
  subtitle = "QR di meja, kasir, papan pesanan, dan laporan dalam satu sistem. Coba 14 hari, tanpa kartu kredit.",
  ...
  return (
    <section className="w-full bg-[#0E59F9] text-white py-20 px-6 sm:px-8">
      <div className="mx-auto max-w-4xl flex flex-col items-center text-center">
        ...
        {/* Heading */}
        <h2 className="text-3xl sm:text-4xl md:text-[42px] font-semibold tracking-[-0.04em] text-white leading-[1.08] mb-4 text-balance">
          {title}
        </h2>
        ...
        <Link
          href={buttonLink}
          className="inline-flex items-center gap-1.5 px-8 py-3.5 rounded-full bg-white text-[#0E59F9] font-semibold text-sm sm:text-base shadow-lg shadow-blue-950/20 hover:bg-white/95 hover:scale-105 active:scale-95 transition-all duration-200"
        >
