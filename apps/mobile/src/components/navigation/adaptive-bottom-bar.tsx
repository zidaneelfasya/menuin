...
export function AdaptiveBottomBar({
  ...
  // Consistent 4-tab Tokopedia navigation across all cashier pages (Dashboard, POS, Orders, Shift, Items, History, Settings)
  const currentMode: BottomBarMode = mode || 'pos';
  ...
  const iconSize = isPhoneLandscape ? 18 : isTablet ? 21 : 22;
  ...
  const isPosActive =
    ...
    pathname === '/' ||
    pathname.endsWith('/(cashier)');
  const isOrdersActive = pathname.includes('/pos/orders') || pathname.includes('/orders');
  ...
  return (
    <View
      style={[
        styles.barContainer,
        {
          minHeight: isPhoneLandscape ? 46 : isTablet ? 58 : 54,
        ...
        <View className="flex-row items-center w-full">
          ...
          <View className="flex-row items-center flex-1">
            ...
            <TouchableOpacity
              ...
              className={`flex-1 ${
                isTablet
                  ? 'flex-row items-center justify-center py-2 px-1.5'
            ...
            >
              ...
              <Text
                ...
                className={
                  isTablet
                    ? 'text-xs ml-2 tracking-tight'
                    : 'text-[10.5px] mt-1 tracking-tight leading-tight'
                }
                numberOfLines={1}
              >
                POS
          ...
          <View className="flex-row items-center flex-1">
            ...
            >
              {isCustomActive ? (
                <ActiveGridIcon size={iconSize} color={MENUIN_BLUE} />
              ) : (
                <LayoutGrid
                  size={iconSize}
                  color="#64748b"
            ...
            >
              {isSettingsActive ? (
                <ActiveSettingsIcon size={iconSize} color={MENUIN_BLUE} />
              ) : (
                <Settings
                  size={iconSize}
                  color="#64748b"
